...
public class OfficeHoursUtils {
    ...
    static String userName = "klevisDemo";
    static String password = "klevis123";
//    static String userName = new Faker().name().fullName();   Ose mund te vendosim random
//    static String password = userName.substring(1,4)+"123";
    ...
    public static boolean negativeLoginTest (WebDriver driver, String url){
        driver.get(url);
        userNameBox(driver).sendKeys(userName.substring(1));  // thjesht hiq nje karakter
        passwordBox(driver).sendKeys(password);
